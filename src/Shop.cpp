        ...
        case 13:
        {
            ...
            while (selling)
            {
                ...
                for (size_t i = 0; i < player.inventory.size(); i++)
                {
                    ...
                    if (player.inventory[i].name == "쓸모없는 돌멩이")
                        sellPrice = 1;
                ...
                else if (sellChoice > 0 && sellChoice <= player.inventory.size())
                {
                    ...
                    else
                    {
                        ...
                        if (player.inventory[index].name == "쓸모없는 돌멩이")
                            sellPrice = 1;

                        cout << GREEN << "\n상인에게 [" << player.inventory[index].name << "]을(를) 팔고 " << sellPrice << "G를 받았습니다!" << RESET << endl;

                        if (player.inventory[index].type == 3 && player.potions > 0)
                            player.potions--;
                        if (player.inventory[index].type == 4 && player.manaPotions > 0)
                            player.manaPotions--;
